...
@section('content')
    <div class="container py-5">
        <div class="card">
            ...
            <form method="POST" id="formulario" action="{{route('prestamistas.store')}}" enctype="multipart/form-data">
                @csrf
                <div class="card-body row">
                    ...
                    <div class="form-group col-12 col-md-3">
                        ...
                        <input type="text"  name="whatsapp"
                            ...
                            placeholder="Ingrese un whatsapp" value="{{ old('whatsapp') }}">
                        @error('whatsapp')
                            <span class="invalid-feedback d-block" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="form-group col-12 col-md-3">
                        ...
                        <input type="number"  name="limiteDiario"
                            ...
                            placeholder="Ingrese limite diario" value="{{ old('limiteDiario') }}" min="1">
                        @error('limiteDiario')
                            <span class="invalid-feedback d-block" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
